...
</select></span><span class="sol3"><?php
...
?></span>
 <div class="alert alert-info" id="lburgaz">  <span class="sol6">Sub Total</span><span class="sol7"><?php
...
$sql7="INSERT INTO Buy (User_id, Product_id) VALUES
    ( (SELECT ID from User WHERE Password='$userP'),(SELECT id from Product WHERE Name='Cooler') )";
$res7=$conn->query($sql7);
 ...
 $mustafa = "UPDATE Product SET Quantity=Quantity-'$nazim1' WHERE Name='Cooler'";
